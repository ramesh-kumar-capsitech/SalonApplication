        ...
        <aside className="fixed h-screen font-inter w-[20%] bg-gradient-to-b from-blue-700 to-blue-600 text-white flex flex-col justify-between px-5 py-6">
            ...
            <div>
                ...
                <nav className="space-y-2">
                    <ul className="text-sm space-y-2 ">
                        ...
                        <NavLink to='/salonadmin/gallery'> <li className="   flex gap-[7px] justify-start hover:bg-white/20  rounded-lg px-3 py-2 " >

                            <PictureOutlined className="text-white " />
                            <p className="font-semibold m-0 "> Gallery</p>
                        </li>
                        </NavLink>
            ...
            <div className="space-y-6">
                ...
                <div className="flex items-center gap-3 bg-white/10 rounded-xl p-3">
                    ...
                    <div>
                        <p className="font-medium m-0">{loggeduser.charAt(0).toUpperCase() + loggeduser.slice(1)}</p>
