...
const test = () => {
    return (
        <div
            id="invoice"
            className="bg-[#f5f7fb] min-h-screen flex justify-center"
            style={{
                width: "794px",
                background: "#fff",
            }}
        >
            <div className="w-[794px] bg-white shadow-2xl rounded-xl overflow-hidden">
                ...
                <div className="bg-[#1E3A8A] text-white px-10 py-4">
                ...
                <div className="grid grid-cols-4 gap-6 px-10 py-3 bg-blue-50 border-b">
                    ...
                    <div className="border rounded-xl overflow-hidden shadow-sm">
                        ...
                        <div className="grid grid-cols-4 gap-6 p-6">
                            ...
                            <div>
                                ...
                                <span className="border border-blue-600 text-blue-700 px-3 py-1 rounded-md font-semibold">
                                    CASH
                                </span>
                            </div>
                ...
                <div className="px-10 pb-10">
                    ...
                    <div className="grid grid-cols-2 gap-8">
                        ...
                        <div>
                            ...
                            <div className="flex items-center gap-3 border border-green-500 bg-green-50 rounded-md px-5 py-3">
